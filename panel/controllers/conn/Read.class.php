...
class Read extends Conn{
    ...
    public function getProduto($Termos = null) {
        ...
        $this->Select = 'SELECT p.id as id_produto, p.nome as nomeProduto, p.id_categoria, p.slug, p.valor, c.nome as categoria, p.descricao, p.peso, p.altura, p.largura, p.comprimento, p.quantidade, cs.cor FROM produtos p inner join categorias c on c.id = p.id_categoria left join cores as cs on p.id_cor = cs.id '.$Termos;
        $this->ExecuteSQL();
    } 
